...
static inline int __count_trailing_zerol(u32 x) { return 32 - __cntlzw(~x & (x - 1)); }
...
void __num2dec_internal(decimal* d, double x) {
...

    {
        ...
        int num_bits_extract = LDBL_MANT_DIG - __count_trailing_zero(frac);
