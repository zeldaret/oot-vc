...
// unused
static u8* GetTextPtr_(ConsoleHead* console, u16 line, u16 xPos) { return 0; }

// unused
static u8* NextLine_(ConsoleHead* console) { return 0; }

// unused
static u8* PutTab_(ConsoleHead* console, u8* dstPtr) { return 0; }

// unused
static u32 GetTabSize_(ConsoleHead* console) { return 0; }

// unused
static u32 PutChar_(ConsoleHead* console, const u8* str, u8* dstPtr) { return 0; }

// unused
static u32 CodeWidth_(const u8* p) { return 0; }

// unused
static ConsoleHead* SearchConsoleFromListByPriority_(u16 r3) { return nullptr; }
...
// unused
static bool TryLockMutex_(OSMutex* mutex) { return false; }
...
// unused
static u8* SearchEndOfLine_(const u8* str) { return 0; }
...
// unused
u16 Console_ChangePriority(ConsoleHead* console, u16 priority) { return 0; }
