...
static SCRegion ProductAreaAndStringTbl[] = {
    {SC_AREA_JPN, "JPN"}, {SC_AREA_USA, "USA"}, {SC_AREA_EUR, "EUR"}, {SC_AREA_AUS, "AUS"}, {SC_AREA_BRA, "BRA"},
    {SC_AREA_TWN, "TWN"}, {SC_AREA_TWN, "ROC"}, {SC_AREA_KOR, "KOR"}, {SC_AREA_HKG, "HKG"}, {SC_AREA_ASI, "ASI"},
    {SC_AREA_LTN, "LTN"}, {SC_AREA_SAF, "SAF"}, {SC_AREA_NONE, ""},
};
...
static inline bool SCGetProductAreaString(char* buf, u32 sz) { return __SCF1("AREA", buf, sz); }
