    ...
    if (rom->unk_19A28 != 0 || rom->unk_19A3C != 0) {
        ...
        if (ret != 1) {
            if (func_800070C4(ret, rom->unk_19A48, rom->unk_19A68, rom->unk_19AFC + rom->unk_19A58) == 0)
                return 0;
            if ((ret == 0xb || ret == -1) && !func_800070D4(&rom->unk_19AC0, rom->unk_19A48, rom->unk_19A68, rom->unk_19AFC + rom->unk_19A58, func_800427C4)) 
                return 0;
        }
    }
...
s32 romSetImage(rom_class_t *rom, char *rom_fn) {
    ...
    if (func_80082074(&file_size, rom->rom_fn)) {
        ...
        rom->unk_19A70 = size;
        if (!xlHeapTake((void**)&rom->common.ref_list, size | 0x70000000) && !func_8005F5F4(gSystem->help_menu, rom, size | 0x70000000, func_80042064)) {
            fret = 0;
        } else {
            fret = 1;
        ...
        case 0x1002:
            switch (cpu_dev->unk_0) {
                case 0:
                    ...
                    break;
                case 1:
                    if (!cpuSetDevicePut(gSystem->cpu, cpu_dev, romPutDebug8, romPutDebug16, romPutDebug32, romPutDebug64)) {
                        return 0;
                    }
                    if (!cpuSetDeviceGet(gSystem->cpu, cpu_dev, romGetDebug8, romGetDebug16, romGetDebug32, romGetDebug64)) {
                        return 0;
                    }
                    break;
            }
