...
class DvdFileStream : public FileStream {
  public:
    ...
    virtual bool ReadAsync(void* pDst, u32 size, StreamCallback pCallback, void* pCallbackArg); // 0x18

    virtual s32 Peek(void* pDst, u32 size); // 0x5C
    virtual bool PeekAsync(void* pDst, u32 size, StreamCallback pCallback, void* pCallbackArg); // 0x60

    virtual void Seek(s32 offset, u32 origin); // 0x44

    virtual void Cancel(); // 0x48
    virtual bool CancelAsync(StreamCallback pCallback, void* pCallbackArg); // 0x4C
  ...
  private:
    ...
    StreamCallback mCancelCallback; // 0x1C
...
class DvdLockedFileStream : public DvdFileStream {
  public:
    ...
    virtual s32 Read(void* pDst, u32 size); // 0x14
    virtual bool ReadAsync(void* pDst, u32 size, StreamCallback pCallback, void* pCallbackArg) { return false; } // 0x18

    virtual s32 Peek(void* pDst, u32 size); // 0x5C
    virtual bool PeekAsync(void* pDst, u32 size, StreamCallback pCallback, void* pCallbackArg) { return false; } // 0x60
