...
class Util {
  ...
  public:
    ...
    static void GetRemoteFilterCoefs(int filter, u16* pB0, u16* pB1, u16* pB2, u16* pA1, u16* pA2);
    static u16 CalcRandom();

  private:
    static const void* GetDataRefAddressImpl(RefType type, u32 value, const void* pBase);
