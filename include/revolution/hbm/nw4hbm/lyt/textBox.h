    ...
    namespace lyt {
        class TextBox : public Pane {
            public:
                ...
                const ut::Color     GetTextColor(u32 type) const                                    { NW4HBMAssert_Line(type < TEXTCOLOR_MAX, 95); return mTextColors[type]; }
                void                SetTextColor(u32 type, ut::Color value)                         { NW4HBMAssert_Line(type < TEXTCOLOR_MAX, 96);  mTextColors[type] = value; }
