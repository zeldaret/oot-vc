 ...
 */
typedef enum {
    SI_SIC0OUTBUF = 0, //!< 0xCD006400
    SI_SIC0INBUFH = 1, //!< 0xCD006404
    SI_SIC0INBUFL = 2, //!< 0xCD006408
    SI_SIC1OUTBUF = 3, //!< 0xCD00640C
    SI_SIC1INBUFH = 4, //!< 0xCD006410
    SI_SIC1INBUFL = 5, //!< 0xCD006414
    SI_SIC2OUTBUF = 6, //!< 0xCD006418
    SI_SIC2INBUFH = 7, //!< 0xCD00641C
    SI_SIC2INBUFL = 8, //!< 0xCD006420
    SI_SIC3OUTBUF = 9, //!< 0xCD006424
    SI_SIC3INBUFH = 10, //!< 0xCD006428
    SI_SIC3INBUFL = 11, //!< 0xCD00642C
    SI_SIPOLL = 12, //!< 0xCD006430
    SI_SICOMSCR = 13, //!< 0xCD006434
    SI_SISR = 14, //!< 0xCD006438
    SI_SIEXILK = 15, //!< 0xCD00643C
