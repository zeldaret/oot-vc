...
def MetroTRKLib(lib_name: str, objects: List[Object]) -> Dict[str, Any]:
    return {
        "lib": lib_name,
        "mw_version": "GC/2.7",
        "cflags": [*cflags_base, "-Cpp_exceptions off", "-O4,p", "-rostr", "-use_lmw_stmw on", "-lang c", "-inline on,deferred", "-func_align 4", "-sdata 0"],
...
config.libs = [
    EmulatorLib(
        ...
        [
            ...
            Object(LinkedFor("oot-j", "oot-u", "oot-e"), "emulator/storeRVL.c", extra_cflags=["-ipa file"]),
    ...
    MetroTRKLib(
        ...
        [
            ...
            Object(NotLinked, "metrotrk/msghndlr.c", extra_cflags=[""]),
            ...
            Object(Linked, "metrotrk/targsupp.s"),
