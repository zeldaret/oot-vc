...
config.libs = [
    ...
    RuntimeLib(
        ...
        [
            ...
            Object(NotLinked, "runtime/New.cpp", extra_cflags=["-Cpp_exceptions on", "-lang c++"]),
            Object(LinkedFor("oot-j"), "runtime/NMWException.cpp", extra_cflags=["-Cpp_exceptions on", "-lang c++"]),
            ...
            Object(NotLinked, "runtime/Gecko_ExceptionPPC.cpp", extra_cflags=["-Cpp_exceptions on", "-lang c++"]),
