...
config.libs = [
    EmulatorLib(
        "emulator",
        [
            Object(LinkedFor(*SM64, *OOT), "emulator/vc64_RVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/system.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/ai.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/vi.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/si.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/pi.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/mi.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/disk.c"),
            Object(NotLinked, "emulator/cpu.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/pif.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/ram.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/rom.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/rdb.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/pak.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/sram.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/flash.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/_frameGCNcc.c"),
            Object(NotLinked, "emulator/_buildtev.c"),
            Object(NotLinked, "emulator/frame.c"),
            Object(LinkedFor(*OOT), "emulator/library.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/codeRVL.c"),
            Object(LinkedFor("sm64-e", *OOT), "emulator/helpRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/soundRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/video.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/storeRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/controller.c", mw_version="GC/3.0a5.2"),
            Object(LinkedFor("sm64-e", *OOT), "emulator/errordisplay.c"),
            Object(LinkedFor("sm64-j", "sm64-u", "oot-j", "oot-u"), "emulator/banner.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/stringtable.c"),
            Object(NotLinked, "emulator/rsp.c"),
            Object(NotLinked, "emulator/rdp.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlCoreRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlPostRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlFileRVL.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlText.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlList.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlHeap.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlFile.c"),
            Object(LinkedFor(*SM64, *OOT), "emulator/xlObject.c"),
        ]
    ),
    RevolutionLib(
        "NdevExi2AD",
