...
config.libs = [
    EmulatorLib(
        ...
        [
            ...
            Object(LinkedFor("oot-j", "oot-u"), "emulator/pi.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/mi.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/disk.c"),
            Object(NotLinked, "emulator/cpu.c", asm_processor=True),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/pif.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/ram.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/rom.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/rdb.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/pak.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/sram.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/flash.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/_frameGCNcc.c"),
            Object(NotLinked, "emulator/_buildtev.c"),
            Object(NotLinked, "emulator/frame.c"),
            Object(NotLinked, "emulator/library.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/codeRVL.c"),
            Object(NotLinked, "emulator/helpRVL.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/soundRVL.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/video.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/store.c", extra_cflags=["-ipa file"]),
            Object(NotLinked, "emulator/controller.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/errordisplay.c"),
            Object(NotLinked, "emulator/banner.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/stringtable.c"),
            Object(NotLinked, "emulator/rsp.c"),
            Object(NotLinked, "emulator/rdp.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlCoreRVL.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlPostRVL.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlFileRVL.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlText.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlList.c", extra_cflags=["-ipa file"]),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlHeap.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlFile.c"),
            Object(LinkedFor("oot-j", "oot-u"), "emulator/xlObject.c"),
        ]
    ),
    RevolutionLib(
        "NdevExi2AD",
